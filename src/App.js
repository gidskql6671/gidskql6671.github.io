...
function App() {
	...
	const [animated_props, set, stop] = useSpring(() => ({}))
	...
	return (
		<div className="App">
			<Container fluid className="p-0">
				<Background>
					<Content backgroundColor="#ef5d50" onClick={() => {selectContentHandler("profile")}}>
					...
					<Content backgroundColor="#2d2d2d" onClick={() => {selectContentHandler("post")}}>
						<h2> zzz </h2>
